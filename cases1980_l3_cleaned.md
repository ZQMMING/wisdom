# 1980-06-22 10:00 男 广州 · 盲派 L3（根因A-E修复版，引擎原始输出）

> 本轮修复：统一地支关系解析层(六合>冲>三刑>穿>破>半合>拱) / 半合拱合六破补全 /
> 暗合边界收紧(相邻柱+六合支锁定) / 负面归因体系(劫财合官·穿官损官=NEGATIVE+效率降档) /
> 日主亲自维度(SELF_DIRECT/LU_SELF/TOOL_ASSISTED/OTHER) / L1e全方法消费(穿官→DAMAGED)。
