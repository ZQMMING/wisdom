...
class TestUnmatched:
    def test_qintian_12_rules_total(self):
        """Z46: 钦天 rule_count=9（Z44 8条 + Z46 北派身宫 + Z48 生年四化015 + Z49 流年四化016 + Z50 大限四化017）, matched + unmatched = 12"""
        chart = make_chart(
            palaces=full_12_palaces_dict(),
            palace_stems=full_12_palace_stems(),
            flying=jiazi_flying(),
