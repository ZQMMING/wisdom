...
li_chun_tests = [
    # (时, 分, 说明, 预期年柱)
    # 2024年立春: 2024-02-04 16:26:53 北京时间
    # P0-1-C fix: 使用钟表时间而非真太阳时判断，立春时刻粒度
    (16, 0, "立春前26分钟", "GUIMAO"),   # 16:00 < 16:26:53，仍在癸卯年
    (16, 26, "立春瞬间", "GUIMAO"),      # 16:26 < 16:26:53，仍在癸卯年
    (16, 30, "立春后4分钟", "JIACHEN"),  # 16:30 > 16:26:53，进入甲辰年
    (17, 0, "立春后34分钟", "JIACHEN"),  # 17:00 > 16:26:53，甲辰年
]
