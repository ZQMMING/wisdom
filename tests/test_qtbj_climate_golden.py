...
CASES = [
    ...
    ('壬', '寅', ['庚', '丙'], 'QTBJ-087-001'),
    ('壬', '卯', ['戊', '辛'], 'QTBJ-088-002'),
    ('壬', '辰', ['甲', '庚'], 'QTBJ-089-001'),
    ('壬', '巳', ['壬', '辛'], 'QTBJ-090-001'),
    ('壬', '午', ['庚', '癸'], 'QTBJ-091-001'),
    ('壬', '未', ['辛', '甲'], 'QTBJ-092-001'),
    ('壬', '申', ['戊', '丁'], 'QTBJ-093-001'),
    ('壬', '酉', ['甲', '庚'], 'QTBJ-094-001'),
    ('壬', '戌', ['甲', '丙'], 'QTBJ-095-002'),
