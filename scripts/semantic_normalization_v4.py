...
def main():
    ...
    for f in evidence_dir.rglob('E-*.json'):
        try:
            ...
            if classic in CLASSIFICATION_RULES:
                ...
                data['normalization_commit'] = 'final-fix-004'
    ...
    for prefix, count in sorted(stats['classic_counts'].items()):
        ...
        name = get_classic_name(PREFIX_TO_CLASSIC.get(prefix, prefix))
