...
print('用神:', ye.get('yongshen_primary'), 'spectrum_tier:', ye.get('spectrum_tier'))

dy = build_dayun_xiji(pillars, ye, ['己酉'], wpo)
step = dy['per_step'][0]
...
_guansha_wx_local = KE_ME.get(dm_wx, '')
print(f'dm_wx={dm_wx}, gan_wx={gan_wx}, zhi_wx={zhi_wx}')
print(f'spectrum_tier={spectrum_tier}, is_shenshuai={is_shenshuai}')
print(f'_guansha_wx_local={_guansha_wx_local}')
print(f'gan_wx==guansha: {gan_wx==_guansha_wx_local}')
print(f'zhi_wx==guansha: {zhi_wx==_guansha_wx_local}')
has_primary = ('GAN_PRIMARY' in step['relations'] or 'ZHI_PRIMARY' in step['relations'] or 'GAN_SHENG_PRIMARY' in step['relations'])
print(f'has_primary_relation: {has_primary}')
shenshuai_guansha_keshen = (is_shenshuai and (gan_wx == _guansha_wx_local or zhi_wx == _guansha_wx_local) and has_primary)
print(f'shenshuai_guansha_keshen={shenshuai_guansha_keshen}')
