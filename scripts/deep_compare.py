...
checks = [
    ...
    ('身弱', ['LIGHT-ROOT', 'JIRUO-WUGEN'], ['俗以', '俗见', '俗论', '俗', '财多', '煞重', '泄重', '似乎', '看似']),
    ('日主旺', ['HEAVY-ROOT'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似']),
    ('日主弱', ['LIGHT-ROOT'], ['俗以', '俗见', '俗论', '俗', '财多', '煞重', '泄重', '似乎', '看似']),
    ('得地', ['HEAVY-ROOT'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '运', '大運']),
    ('得时', ['DESHI-BUWANG'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '运', '大運']),
    ('得令', ['DESHI-BUWANG'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '运', '大運']),
    ('失令', ['SHISHI-BURUO'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '运', '大運']),
    ('得势', ['YIN-PARTY', 'BIJIE-PARTY'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '运', '大運']),
]
