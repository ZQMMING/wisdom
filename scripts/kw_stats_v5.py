...
checks = [
    ('身旺', ['HEAVY-ROOT', 'YIN-PARTY', 'BIJIE-PARTY'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '身旺者', '身旺逢', '必要身旺', '不宜身旺', '身旺之地', '非原命', '身旺财旺', '身旺用财', '身旺喜', '身旺也', '此命身旺', '举例如', '又如', '若逢', '若月令', '运行身旺', '行运身旺', '岁运身旺', '身旺/身弱', '若身旺', '身旺无杂', '身旺为官', '最重日元身旺']),
