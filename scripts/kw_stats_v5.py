...
checks = [
    ('身旺', ['HEAVY-ROOT', 'YIN-PARTY', 'BIJIE-PARTY'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '身旺者', '身旺逢', '必要身旺', '不宜身旺', '身旺之地', '非原命', '身旺财旺', '身旺用财', '身旺喜', '身旺也', '此命身旺', '举例如', '又如', '若逢', '若月令']),
    ('身强', ['HEAVY-ROOT', 'YIN-PARTY', 'BIJIE-PARTY'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '身强者']),
    ('身弱', None, ['俗以', '俗见', '俗论', '俗', '财多', '煞重', '泄重', '似乎', '看似', '弱中', '弱变', '弱不', '非身弱', '不论身', '身弱者', '虽辰为水库', '王太仆造', '平江伯命', '罗状元命', '丞相命', '论财篇', '论印篇']),
    ...
    ('旺极', ['JIWANG-HUAIJI'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '地旺极', '火旺极', '土旺极', '金旺极', '水旺极', '木旺极', '财旺极', '印旺极', '官旺极', '杀旺极', '偏财旺极', '伤官旺极', '食神旺极', '比劫旺极', '羊刃旺极', '旺极反衰', '旺极所化', '旺极矣', '极旺极衰', '身印旺地', '天元太弱', '七杀当旺', '官星旺运', '乘权当令']),
