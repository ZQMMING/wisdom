...
checks = [
    ...
    ('中和', ['ZHONG-HE'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '不得中和之气', '贵中和']),
    ('旺极', ['JIWANG-HUAIJI'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '地旺极', '火旺极', '土旺极', '金旺极', '水旺极', '木旺极', '财旺极', '印旺极', '官旺极', '杀旺极', '偏财旺极', '伤官旺极', '食神旺极', '比劫旺极', '羊刃旺极', '旺极反衰', '旺极所化', '旺极矣', '极旺极衰', '身印旺地', '天元太弱', '七杀当旺', '官星旺运', '乘权当令', '林注', '身旺极贫', '旺极之象征', '水泛木浮', '注：此造']),
    ('衰极', ['JISHUAI-CONGSHENG'], ['俗以', '俗见', '俗论', '俗', '似乎', '看似', '天衰极', '火衰极', '土衰极', '金衰极', '水衰极', '木衰极', '臣盛君衰极']),
