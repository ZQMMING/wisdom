...
pillars = {'year': '辛丑', 'month': '丙申', 'day': '壬申', 'hour': '辛亥'}
...
print('=== QT-0684 辛丑 丙申 壬申 辛亥 ===')
print('climate_candidates:', clc.get('climate_candidates'))
print('天干:', [pillars[k][0] for k in ('year','month','day','hour')])
