...
pillars = {'year': '乙未', 'month': '辛巳', 'day': '丙午', 'hour': '甲午'}
...
print('=== YH-0148 乙未 辛巳 丙午 甲午 ===')
print('zhuanwang:', spc.get('zhuanwang'))
print('zhuanwang_state:', spc.get('zhuanwang_state'))
print('cong_type:', spc.get('cong_type'))
print('cong_state:', spc.get('cong_state'))
print('hua_type:', spc.get('hua_type'))
print('patterns:', [p.get('pattern_name') for p in spc.get('patterns', [])])
print()
print('combination_facts sanhui:', f['combination_facts'].get('sanhui', []))
print('combination_facts sanhe:', f['combination_facts'].get('sanhe', []))
print()
wp = wpo['wuxing_power']
for wx_name in ['木','火','土','金','水']:
    d = wp.get(wx_name, {})
    print(f'{wx_name}: stem_n={d.get("stem_n")}, ben_n={d.get("ben_n")}, zhong_n={d.get("zhong_n")}, yu_n={d.get("yu_n")}, ling={d.get("ling_state")}, ju_n={d.get("ju_n",0)}')
