...
# 回退V1.3的月令力量修正, 恢复V1.2的简单逻辑
old = """        # V1.3: 月令力量修正 - 大运五行得月令生扶则力量强
...
# 修改module版本号
c = c.replace("'module': 'DAYUN_XIJI_V1.3'", "'module': 'DAYUN_XIJI_V1.2'")
