...
for m in mismatches:
    ...
    is_cai_guansha = (gan_wx == cai_wx and zhi_wx == guansha_wx)
    # 比劫+食伤
    shishang_wx = SHENG.get(dm_wx, '')
    is_bijie_shishang = (gan_wx == dm_wx and zhi_wx == shishang_wx)
    
    if not (is_cai_guansha or is_bijie_shishang):
        continue
    ...
    try:
        ...
        combo_type = '财+官杀' if is_cai_guansha else '比劫+食伤'
