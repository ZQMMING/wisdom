...
pillars={'year':('庚','寅'),'month':('己','丑'),'day':('壬','辰'),'hour':('辛','亥')}
facts=build(pillars)
...
print()
print('combination_facts sanhui:', facts['combination_facts'].get('sanhui', []))
print('combination_facts sanhe:', facts['combination_facts'].get('sanhe', []))
