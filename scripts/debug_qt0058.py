...
pillars = {'year': '甲辰', 'month': '甲戌', 'day': '甲辰', 'hour': '甲戌'}
...
print('=== QT-0058 甲辰 甲戌 甲辰 甲戌 ===')
print('root_facts:', f.get('root_facts'))
print('root_classes:', rc)
print()
print('special_patterns keys:', list(spc.keys()))
for k, v in spc.items():
    if isinstance(v, dict):
        print(f'  {k}: name={v.get("name")}, state={v.get("state")}, confirmed={v.get("confirmed")}')
print()
print('climate_candidates:', clc)
print()
print('yongshen_primary:', ye.get('yongshen_primary'))
print('yongshen_path:', ye.get('yongshen_path'))
