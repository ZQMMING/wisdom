...
# V4.30修正: _yinbi_rooted检查中气根+余气根(辰中乙木是中气不是余气)
old = """    # V4.30: 从财/从官/从杀格有印比透干且有根(本气/余气)时不走从格(假从真不化)，从儿格不受此限
...
new = """    # V4.30: 从财/从官/从杀格有印比透干且有根(本气/中气/余气)时不走从格(假从真不化)，从儿格不受此限
...
with open(p, 'w', encoding='utf-8', newline='') as f:
    f.write(c)
print('yongshen_engine.py V4.30修正完成(_yinbi_rooted检查中气+余气根)')
