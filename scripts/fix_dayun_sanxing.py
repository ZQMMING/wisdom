...
# 修改综合喜忌标签逻辑, 增加三刑判断
old2 = """        hai_primary_any = any('HAI_' in r and '_PRIMARY' in r for r in relations)
...
# 修改克泄判断, 增加三刑
old3 = """        elif 'GAN_AVOID' in relations or 'ZHI_AVOID' in relations or 'GAN_KE_PRIMARY' in relations or hidden_avoid_any or chong_primary_any or he_avoid_any or hai_primary_any:"""
new3 = """        elif 'GAN_AVOID' in relations or 'ZHI_AVOID' in relations or 'GAN_KE_PRIMARY' in relations or hidden_avoid_any or chong_primary_any or he_avoid_any or hai_primary_any or xing_primary_any:"""
c = c.replace(old3, new3)

# 修改module版本号
c = c.replace("'module': 'DAYUN_XIJI_V2.5'", "'module': 'DAYUN_XIJI_V2.6'")

with open(p, 'w', encoding='utf-8', newline='') as f:
    f.write(c)
print('dayun_xiji.py V2.6优化完成(增加三刑四支判断)')
