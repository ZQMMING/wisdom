...
def get_ziping_index_paths_for_case(features: dict[str, Any]) -> dict[str, dict[str, Any]]:
    ...
    paths["STRENGTH_PATH"] = {"school": ZiPingSchool.DI_TIAN_SUI.value, "name_zh": "滴天髓 - 强弱/气势路径", "input_features": {"day_master": features.get("ZP.DAY_MASTER"), "month_branch": features.get("ZP.MONTH_BRANCH"), "five_element_balance": features.get("ZP.FIVE_ELEMENT_BALANCE"), "branch_clash_map": features.get("ZP.BRANCH_CLASH_MAP"), "branch_he_map": features.get("ZP.BRANCH_HE_MAP")}, "judgment_types": ["STRENGTH", "QI_SHI", "STRUCTURE_LEVEL", "STEM_IMAGE"], "matcher": "GRAPH"}
    return paths
