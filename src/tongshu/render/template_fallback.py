...
class TemplateFallback:
    ...
    TEMPLATES = {
        ...
        ("WORK", "CONFLICTED"): "今日【WORK】主题方向存在内在张力。宜守不宜攻，先稳住再调整。今日宜先稳住现状，把分散的能量收拢到一件确定的事上，不强推新的方向，以静制动反而能化解张力。",
        ...
        ("RELATION", "CONFLICTED"): "今日【RELATION】主题方向存在张力。宜保持边界，不强推。今日宜守住自己的边界，把想要调整对方的冲动先收起来，把注意力放回自己能负责的部分，让关系自然舒展。",
        ...
        ("EMOTION", "CONFLICTED"): "今日【EMOTION】主题存在内在拉扯。宜安住不评判。今日宜允许内在的拉扯存在，不急着调和，让两种声音都被听见，安住本身即是答案。",
        ...
        ("LEARNING", "CONFLICTED"): "今日【LEARNING】主题方向存在内在张力。宜专注一处不贪多。今日宜把注意力收回到一件确定的学习对象上，不要在多个方向同时用力，让专注本身化解张力。",
        ...
        ("FAMILY_SOCIAL", "CONFLICTED"): "今日【FAMILY_SOCIAL】主题存在张力。宜守分寸。今日宜守住自己的边界与对方的边界，不强行调整关系，把注意力放回自己能负责的部分，让张力自然缓和。",
        ...
        ("ACTION_LIFE", "CONFLICTED"): "今日【ACTION_LIFE】主题存在内在张力。宜评估后缓行。今日宜先评估当前行动的真实成本与收益，不强推，让内在张力通过延后决定而自然化解，再择机行动。",
