...
class YongShenEngine:
    ...
    TIAOHOU_TABLE = {
        ...
        "MAO": {
            ...
            "GUI": {"yong": 'METAL', "help": None, "ji": None, "cond": ['XIN'], "status": 'supported', "quote": '二月癸水，不刚不柔，乙木司令，泄弱元神，专用庚金为用，辛金次之，庚辛俱透，无丁出干者，贵由科甲，无庚辛者常人。', "ref": 'QTBJ_transcription(qiongtong:c006:p0143)', "note": 'rev16'},
        },
        "CHEN": {
