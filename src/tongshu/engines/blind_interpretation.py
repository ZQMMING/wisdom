...
VALUE_SEMANTICS: Dict[str, Dict[str, tuple]] = {
    ...
    "blind_wangshuai": {
        "WANG_JI": ("盲派旺衰·旺极（《命理玄机探秘》四定律界定；弃旺衰，仅状态分类）", "日主力量旺到极致，做事气势一面倒"),
        "TAI_RUO": ("盲派旺衰·太弱（《命理玄机探秘》四定律界定；弃旺衰，仅状态分类）", "日主力量太弱，难以自立"),
        "WANG": ("盲派旺衰·身旺（《命理玄机探秘》四定律界定；弃旺衰，仅状态分类）", "日主自身力量强旺，做事有底气"),
        "ZHONG_HE_PIAN_RUO": ("盲派旺衰·中和偏弱（《命理玄机探秘》四定律界定；弃旺衰，仅状态分类）", "日主力量中和偏弱，做事易受牵制"),
        "RUO": ("盲派旺衰·身弱（《命理玄机探秘》四定律界定；弃旺衰，仅状态分类）", "日主自身力量偏弱，做事易受牵制"),
        "UNDETERMINED": ("盲派旺衰·证据不足（fail-closed，不做断言）", "旺衰判定证据不足，不做断言"),
    },
    "five_element_imbalance": {
        "TRUE": ("五行失衡（八字排盘层五行统计事实，非盲派口诀）", "五行分布不均，性情有偏"),
        "FALSE": ("五行均衡（八字排盘层五行统计事实，非盲派口诀）", "五行相对均衡，性情较平和"),
    },
    # ── THEME-002 交游人际 ────────────────────────────────
    "zuo_gong.比劫做功": {
        "EFFECTIVE": ("盲派做功·比肩去财（段建业讲义：制用五种之'比肩去财'；有比劫制财局和财制比劫局两种）", "靠朋友伙伴/竞争手段取财的路径成立"),
    ...
    "children.palace_hit": {
        "STABLE": ("段建业《盲派八字命理口诀·子女》：时柱=子女宫，忌冲忌伤忌枭印驾临（皆无=安稳）", "子女宫安稳，无冲穿枭印之扰"),
    },
    # ── THEME-005 财帛 ────────────────────────────────────
    "wealth_event_structure.wealth_state": {
        "DIRECTED_AND_ESTABLISHED": ("盲派财富·有势又有功定是富贵翁（VERIFY-BLIND-024：财官在主位就是我的财官）+ 财现+财被取+做功成（生用结构·食伤生财/制用五种·制财）", "财星到手，取财的路径成立，求财有成"),
    ...
    "body_event_candidate.candidate": {
        "LU_UNDER_ATTACK": ("盲派口诀·禄怕见绝更怕穿害（盲派身体章：禄神被穿/合克/脆金则受损）", "禄神受损（被穿、被合克、被燥土脆金），身体或福气易受影响"),
    ...
    "official_event_structure.official_state": {
        ...
        "CONTROLLED_PARTIAL": ("盲派口诀·官杀制不净当财看（《盲派中级命理学·官贵章》：制不净则当财看）", "官杀有制但制不净，功名/职位有限"),
    ...
    "zuo_gong.印做功": {
        "EFFECTIVE": ("盲派六亲损断·印旺身强多福寿，六亲和睦家道丰", "印做功成立，主福寿、家道和睦"),
    ...
    "zuo_gong.食伤泄秀(才艺)": {
        "EFFECTIVE": ("段建业《盲派中级命理学》第11章：食神主思想思考、主学习好", "食伤泄秀成立，主思想活跃、学习能力强"),
...
EVENT_SEMANTICS: Dict[str, tuple] = {
    ...
    "OFFICIAL_PARTIAL": ("盲派口诀·官杀制不净当财看（《盲派中级命理学·官贵章》，BLIND-DJ-007）", "官杀制不净当财看，功名层次有限"),
    ...
    "OCCUPATION_DIRECTION_CANDIDATE": ("盲派职业·做功类型映射职业候选（VERIFY-BLIND-026：食神制煞靠技能权谋/杀印相生靠贵人平台）", "职业方向有候选，具体见职业方向条目"),
    "BODY_LU_ATTACK": ("盲派口诀·禄怕见绝更怕穿害（盲派身体章：禄神被穿害则受损，BLIND-DJ-002）", "禄神受损（被穿/合克），身体或福气易受影响"),
...
TIME_KIND_SEMANTICS: Dict[str, tuple] = {
    ...
    "SANXING": ("盲派应期·三刑（段建业《盲派中级命理学》第02章：丑未戌/寅巳申三刑应期主凶；恃势/无恩细分属《三命通会》卷二·论三刑，METHOD_SCOPE=TRADITIONAL）", "口舌纠纷/官非/灾伤"),
    ...
    "ZIXING": ("传统命理·自刑（《三命通会》：辰午酉亥自见为自刑；段建业第02章无自刑应期原文，METHOD_SCOPE=TRADITIONAL）", "自我消耗/口舌"),
