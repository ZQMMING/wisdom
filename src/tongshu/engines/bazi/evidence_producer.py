        ...
        for pillar_name, pillar, scope in pillars:
            ...
            evidences.append(
                EngineEvidence(
                    ...
                    source_rule_ref="data/rules/bazi_stems.json",
            ...
            evidences.append(
                EngineEvidence(
                    ...
                    source_rule_ref="data/rules/bazi_branches.json",
            ...
            for key, vals in chart.branch_clash_map.items():
                evidences.append(
                    EngineEvidence(
                        ...
                        source_rule_ref="data/rules/bazi_branch_relations.json",
        ...
        if chart.peach_blossom:
            evidences.append(
                EngineEvidence(
                    ...
                    source_rule_ref="data/rules/bazi_peach_blossom.json",
        ...
        if chart.five_element_imbalance:
            evidences.append(
                EngineEvidence(
                    ...
                    source_rule_ref="data/rules/bazi_five_elements.json",
