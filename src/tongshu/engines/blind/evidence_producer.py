...
from ..blind_bazi_engine import BlindBaziResult
    ...
    def produce(
        ...
        evidences.append(
            EngineEvidence(
                ...
                source_rule_ref="data/rules/blind_main_guest.json",
        ...
        evidences.append(
            EngineEvidence(
                ...
                source_rule_ref="data/rules/blind_ti_yong.json",
        ...
        evidences.append(
            EngineEvidence(
                ...
                attributes={
                    ...
                    "zuo_gong_detail": result.zuo_gong_detail,
                },
                source_rule_ref="data/rules/blind_zuogong.json",
        ...
        if result.transparent_ten_gods:
            evidences.append(
                EngineEvidence(
                    ...
                    source_rule_ref="data/rules/blind_ten_gods.json",
