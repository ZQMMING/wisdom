        ...
        if gua_name:
            evidences.append(
                EngineEvidence(
                    ...
                    source_rule_ref="data/rules/yi_hexagrams.json",
        ...
        if gua_ci:
            evidences.append(
                EngineEvidence(
                    ...
                    source_rule_ref="data/rules/yi_gua_ci.json",
                    source_field="gua_ci",
                    calculation_version=self.CALC_VERSION,
                    contract_version=self.CONTRACT_VERSION,
                )
            ...
            if yao_position:
                evidences.append(
                    EngineEvidence(
                        ...
                        source_rule_ref="data/rules/yi_yao.json",
            ...
            if yao_text:
                evidences.append(
                    EngineEvidence(
                        ...
                        source_rule_ref="data/rules/yi_yao_ci.json",
