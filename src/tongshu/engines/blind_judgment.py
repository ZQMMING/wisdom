...
RESPONSE_ACTION_SEMANTICS: Dict[str, tuple] = {
    ...
    "sanxing": ("DISCORD", "主口舌", "段建业《盲派中级命理学》第02章：丑未戌/寅巳申三刑应期主凶（官非/灾伤）；恃势/无恩细分属《三命通会》卷二·论三刑（METHOD_SCOPE=TRADITIONAL）"),
    "zixing": ("DISCORD", "主口舌", "传统命理·自刑（《三命通会》辰午酉亥自见为自刑；盲派第02章无此原文，METHOD_SCOPE=TRADITIONAL）"),
