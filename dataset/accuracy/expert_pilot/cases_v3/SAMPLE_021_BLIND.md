# SAMPLE_021 — Blind Evaluation (v3)
...
- 年柱: Pillar(heavenly_stem='GUI', earthly_branch='MAO')
- 月柱: Pillar(heavenly_stem='JI', earthly_branch='WEI')
- 日柱: Pillar(heavenly_stem='REN', earthly_branch='ZI')
- 时柱: Pillar(heavenly_stem='BING', earthly_branch='WU')
...
### 易经解释
- **状态**: 卦象：地山谦卦；上坤☷(土)下艮☶(土)；体用关系：比和（平）；元堂：上六；爻辞原文：'鸣谦，利用行师，征邑国。'；爻义：鸣谦，利用行师，征邑国，谦逊之名可用於征伐；大象：地中有山，谦。君子以裒多益寡，称物平施。。
- **机会**: 体用内外一致，能量协调，宜稳步推进；爻辞启示：鸣谦，利用行师，征邑国，谦逊之名可用於征伐；有利方向：你的谦逊已经形成强大的道义力量，可以用来领导军队/团队。征伐自己的属地（邑国）——先管好自己的地盘，再图扩展；相关领域：谦虚、低调、积累。
- **风险**: 爻位分析：上爻阴居阳位，不当位。上六处谦卦之极，鸣谦利用行师。谦极而用武，征邑国之象；注意领域：道义领导、征伐自卫、先安内再图外。
- **建议**: 策略建议：你的谦逊已经形成强大的道义力量，可以用来领导军队/团队。征伐自己的属地（邑国）——先管好自己的地盘，再图扩展；五行态势：下卦土，上卦土；同气相应，宜顺势而为，不宜强行改变方向。
- **行动**: 参考周易·谦卦·上六：'鸣谦，利用行师，征邑国。'。你的谦逊已经形成强大的道义力量，可以用来领导军队/团队。征伐自己的属地（邑国）——先管好自己的地盘，再图扩展。；水性主智，宜灵活变通，善用策略与时机。
- **方向**: NEUTRAL
- **来源**: 周易·地山谦·卦辞, 周易·谦卦·上六, 错卦:天泽履, 综卦:山地剥
- **置信度**: 0.8
