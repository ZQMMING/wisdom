# SAMPLE_020 — Blind Evaluation (v3)
...
- 年柱: Pillar(heavenly_stem='DING', earthly_branch='MAO')
- 月柱: Pillar(heavenly_stem='JIA', earthly_branch='CHEN')
...
- **行动**: 参考周易·谦卦·上六：'鸣谦，利用行师，征邑国。'。你的谦逊已经形成强大的道义力量，可以用来领导军队/团队。征伐自己的属地（邑国）——先管好自己的地盘，再图扩展。；木性主仁，宜温和推进，善借人脉与成长机会。
- **方向**: NEUTRAL
