# SAMPLE_007 — Blind Evaluation (v3)
...
- 年柱: Pillar(heavenly_stem='YI', earthly_branch='HAI')
- 月柱: Pillar(heavenly_stem='YI', earthly_branch='YOU')
- 日柱: Pillar(heavenly_stem='JI', earthly_branch='WEI')
- 时柱: Pillar(heavenly_stem='WU', earthly_branch='CHEN')
...
### 易经解释
- **状态**: 卦象：地山谦卦；上坤☷(土)下艮☶(土)；体用关系：比和（平）；元堂：九五；爻辞原文：'不富以其邻，利用侵伐，无不利。'；爻义：不富以其邻，利用侵伐，无不利，不以富贵骄人而能打硬仗；大象：地中有山，谦。君子以裒多益寡，称物平施。。
- **机会**: 体用内外一致，能量协调，宜稳步推进；爻辞启示：不富以其邻，利用侵伐，无不利，不以富贵骄人而能打硬仗；有利方向：虽然不富裕，但与邻居合作可以完成困难的任务。必要时可以动用武力/强硬手段（侵伐），这是正当的。适合联合行动、反击不公；相关领域：谦虚、低调、积累。
- **风险**: 爻位分析：五爻阴居阳位，不当位但得中。六五居上卦之中，不富以邻，利用侵伐。柔中而能断，正义之师；注意领域：联合行动、反击不公、正义之战。
- **建议**: 策略建议：虽然不富裕，但与邻居合作可以完成困难的任务。必要时可以动用武力/强硬手段（侵伐），这是正当的。适合联合行动、反击不公；五行态势：下卦土，上卦土；同气相应，宜顺势而为，不宜强行改变方向。
- **行动**: 参考周易·谦卦·六5：'不富以其邻，利用侵伐，无不利。'。虽然不富裕，但与邻居合作可以完成困难的任务。必要时可以动用武力/强硬手段（侵伐），这是正当的。适合联合行动、反击不公。；土性主信，宜稳重扎实，积累信誉与人脉。
- **方向**: NEUTRAL
- **来源**: 周易·地山谦·卦辞, 周易·谦卦·六5, 错卦:天泽履, 综卦:山地剥
- **置信度**: 0.8
