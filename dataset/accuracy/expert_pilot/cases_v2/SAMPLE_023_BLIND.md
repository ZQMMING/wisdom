# SAMPLE_023 — Blind Evaluation (v2)
...
### 关系式解释（系统输出）
- 日主：JI；评估窗口：2016–2036（命主 35–55 岁，聚焦信号最集中的关键年份）
...
- 【年度焦点】信号叠加最强的年份及具体规则机制：
  ...
  · 2027 年（3 个动态信号）：
      - ETP-MAR-105-05 [变动] 男命财星弱/无根 → 妻星不显 → 婚姻迟滞（依据 E-K2G-SHIPI-009）
      - ETP-SUY-101-06 [机会] 岁运并临且主气十神为喜用(比印) → 吉信号放大（依据 E-K2G-DAYUN-002）
      - ETP-WLT-104-08 [风险] 流年支冲日支 → 财运波动（依据 E-K2G-DAYUN-002）
