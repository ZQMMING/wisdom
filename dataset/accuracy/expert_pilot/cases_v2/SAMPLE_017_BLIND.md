# SAMPLE_017 — Blind Evaluation (v2)
...
### 关系式解释（系统输出）
- 日主：GUI；评估窗口：1993–2013（命主 35–55 岁，聚焦信号最集中的关键年份）
...
- 【年度焦点】信号叠加最强的年份及具体规则机制：
  ...
  · 2001 年（3 个动态信号）：
      ...
      - ETP-WLT-101-08 [机会] 流年财星当值(正财/偏财) → 财运机会（依据 E-K2G-DAYUN-002）
      - ETP-WLT-104-09 [风险] 流年支冲日支 → 财运波动（依据 E-K2G-DAYUN-002）
  · 2004 年（3 个动态信号）：
      - ETP-CRR-102-00 [机会] 流年正印/偏印当值 → 事业助力（依据 E-K2G-DAYUN-002）
