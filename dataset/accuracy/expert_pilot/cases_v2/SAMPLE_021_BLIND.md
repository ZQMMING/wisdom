# SAMPLE_021 — Blind Evaluation (v2)
...
### 关系式解释（系统输出）
- 日主：YI；评估窗口：2014–2034（命主 35–55 岁，聚焦信号最集中的关键年份）
...
- 【年度焦点】信号叠加最强的年份及具体规则机制：
  ...
  · 2016 年（2 个动态信号）：
      ...
      - ETP-SUY-102-01 [风险] 岁运并临且主气十神为忌神(食伤财官) → 凶信号放大（依据 E-K2G-DAYUN-002）
  · 2018 年（2 个动态信号）：
      - ETP-SUY-102-00 [风险] 岁运并临且主气十神为忌神(食伤财官) → 凶信号放大（依据 E-K2G-DAYUN-002）
      - ETP-WLT-101-02 [机会] 流年财星当值(正财/偏财) → 财运机会（依据 E-K2G-DAYUN-002）
