"""Phase 7-10 管线测试 · sanming_tonghui。"""
...
def test_judgment_assertions():
    from engines.sanming_tonghui.judgment.judgment_builder import build_assertions
...
def test_provenance_record():
    from engines.sanming_tonghui.provenance.provenance import ProvenanceRecorder
...
def test_regression_harness():
    from engines.sanming_tonghui.regression.regression_harness import DEMO_CHART, compare, snapshot_all
