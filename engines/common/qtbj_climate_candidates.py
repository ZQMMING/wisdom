...
_CLIMATE_TABLE: Dict = {
    ...
    ('癸', '寅'): {  # 正月癸水: 先用辛金生癸源, 次用丙火照暖
        'candidates': [('辛', 1), ('丙', 2)],
        'evidence_refs': ['QTBJ-099-001'],
    },
    ('癸', '卯'): {  # 二月癸水: 乙木司令泄弱, 专用庚金, 辛金次之
        'candidates': [('庚', 1), ('辛', 2)],
        'evidence_refs': ['QTBJ-100-001'],
    },
    ('癸', '辰'): {  # 三月癸水: 专用丙火和阴阳, 辛金佐之
        'candidates': [('丙', 1), ('辛', 2)],
        'evidence_refs': ['QTBJ-101-001'],
    },
    ('癸', '巳'): {  # 四月癸水: 喜辛金为用, 无辛用庚
        'candidates': [('辛', 1)],
        'evidence_refs': ['QTBJ-102-001'],
    },
    ('癸', '午'): {  # 五月癸水: 至弱无根须庚辛生身, 参酌壬
        'candidates': [('庚', 1), ('辛', 2)],
        'evidence_refs': ['QTBJ-103-001'],
    },
    ('癸', '未'): {  # 六月癸水: 未中有乙己同宫, 专用庚辛
        'candidates': [('庚', 1), ('辛', 2)],
        'evidence_refs': ['QTBJ-104-001'],
    },
    ('癸', '申'): {  # 七月癸水: 庚司令刚锐极, 必取丁火为用, 甲为焰
        'candidates': [('丁', 1), ('甲', 2)],
        'evidence_refs': ['QTBJ-105-001'],
    },
    ('癸', '酉'): {  # 八月癸水: 取辛金为用, 丙火生水暖金
        'candidates': [('辛', 1), ('丙', 2)],
        'evidence_refs': ['QTBJ-106-001'],
    },
    ('癸', '戌'): {  # 九月癸水: 专用辛金发水, 甲木制戊
        'candidates': [('辛', 1), ('甲', 2)],
        'evidence_refs': ['QTBJ-107-001'],
    },
    ('癸', '亥'): {  # 十月癸水: 旺中有弱因亥木泄, 宜庚辛
        'candidates': [('庚', 1), ('辛', 2)],
        'evidence_refs': ['QTBJ-108-001'],
    },
    ('癸', '子'): {  # 十一月癸水: 冰冻专用丙火解冻, 辛金滋扶
        'candidates': [('丙', 1), ('辛', 2)],
        'evidence_refs': ['QTBJ-109-001'],
    },
    ('癸', '丑'): {  # 十二月癸水: 寒极成冰, 宜丙火解冻
        'candidates': [('丙', 1)],
        'evidence_refs': ['QTBJ-110-001'],
    },
}
